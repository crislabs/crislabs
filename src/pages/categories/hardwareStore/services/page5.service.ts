...
import { HardwareStorePage5 } from 'src/common/entities/page.model';
...
@Injectable()
export class HardwareStorePage5Service {
  constructor(
    @InjectModel(HardwareStorePage5.name, 'hardwareStoreDB')
