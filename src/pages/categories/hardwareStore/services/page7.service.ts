...
import { HardwareStorePage7 } from 'src/common/entities/page.model';
...
@Injectable()
export class HardwareStorePage7Service {
  constructor(
    @InjectModel(HardwareStorePage7.name, 'hardwareStoreDB')
