...
import { HardwareStorePage10 } from 'src/common/entities/page.model';
...
@Injectable()
export class HardwareStorePage10Service {
  constructor(
    @InjectModel(HardwareStorePage10.name, 'hardwareStoreDB')
