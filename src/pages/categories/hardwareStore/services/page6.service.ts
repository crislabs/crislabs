...
import { HardwareStorePage6 } from 'src/common/entities/page.model';
...
@Injectable()
export class HardwareStorePage6Service {
  constructor(
    @InjectModel(HardwareStorePage6.name, 'hardwareStoreDB')
