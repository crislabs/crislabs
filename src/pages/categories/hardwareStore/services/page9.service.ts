...
import { HardwareStorePage9 } from 'src/common/entities/page.model';
...
@Injectable()
export class HardwareStorePage9Service {
  constructor(
    @InjectModel(HardwareStorePage9.name, 'hardwareStoreDB')
