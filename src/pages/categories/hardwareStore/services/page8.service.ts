...
import { HardwareStorePage8 } from 'src/common/entities/page.model';
...
@Injectable()
export class HardwareStorePage8Service {
  constructor(
    @InjectModel(HardwareStorePage8.name, 'hardwareStoreDB')
