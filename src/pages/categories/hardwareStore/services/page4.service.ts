...
import { HardwareStorePage4 } from 'src/common/entities/page.model';
...
@Injectable()
export class HardwareStorePage4Service {
  constructor(
    @InjectModel(HardwareStorePage4.name, 'hardwareStoreDB')
