...
import { HardwareStorePage12 } from 'src/common/entities/page.model';
...
@Injectable()
export class HardwareStorePage12Service {
  constructor(
    @InjectModel(HardwareStorePage12.name, 'hardwareStoreDB')
