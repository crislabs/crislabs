...
import { HardwareStorePage11 } from 'src/common/entities/page.model';
...
@Injectable()
export class HardwareStorePage11Service {
  constructor(
    @InjectModel(HardwareStorePage11.name, 'hardwareStoreDB')
